  ...
  return (
    <div>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 p-6">
        {/* Currency Converter */}
        <div className="bg-gray-900 rounded-lg shadow-md p-6 flex flex-col items-center hover:shadow-xl transition-transform duration-300 transform hover:scale-105 animate-fadeIn">
        ...
        {/* Spotify Clone */}
        <div className="bg-gray-900 rounded-lg shadow-md p-6 flex flex-col items-center hover:shadow-xl transition-transform duration-300 transform hover:scale-105 animate-fadeIn delay-100">
        ...
        {/* To-Do App */}
        <div className="bg-gray-900 rounded-lg shadow-md p-6 flex flex-col items-center hover:shadow-xl transition-transform duration-300 transform hover:scale-105 animate-fadeIn delay-200">
        ...
        {/* User Dashboard */}
        <div className="bg-gray-900 rounded-lg shadow-md p-6 flex flex-col items-center hover:shadow-xl transition-transform duration-300 transform hover:scale-105 animate-fadeIn delay-300">
